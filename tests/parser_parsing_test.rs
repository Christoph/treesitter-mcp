use treesitter_cli::parser::Language;

#[test]
fn test_parse_rust_code() {
    let code = "fn main() { println!(\"hello\"); }";
    let tree = treesitter_cli::parser::parse_code(code, Language::Rust).unwrap();
...
fn test_parse_python_code() {
    let code = "def hello():\n    print('world')";
    let tree = treesitter_cli::parser::parse_code(code, Language::Python).unwrap();
...
fn test_parse_javascript_code() {
    ...
    let tree = treesitter_cli::parser::parse_code(code, Language::JavaScript).unwrap();
...
fn test_parse_typescript_code() {
    ...
    let tree = treesitter_cli::parser::parse_code(code, Language::TypeScript).unwrap();
...
fn test_parse_html_code() {
    ...
    let tree = treesitter_cli::parser::parse_code(code, Language::Html).unwrap();
...
fn test_parse_css_code() {
    ...
    let tree = treesitter_cli::parser::parse_code(code, Language::Css).unwrap();
